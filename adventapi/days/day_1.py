from adventapi.days.lib.input_handlers import double_split_content, read_file


file_contents = read_file("adventapi/days/day_1_input.txt")
...
def solve(input=file_contents):
    ...
    return {1: maxCalories, 2: top_calories}
