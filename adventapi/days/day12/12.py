...
file_contents = read_file("day12/12input.txt")
...
print_answer("12.1", get_shortest_path(starting_point, ending_point))
print_answer("12.2", get_shortest_path_from_any_low_point())
