...
file_contents = read_file("advent_days/days/day_11_input.txt")
...
def solve(text_input=file_contents):
    ...
    return({1:monkey_business(parse_monkeys(), 20, operation=lambda x: x // 3), 2:monkey_business_with_module(parse_monkeys())})
