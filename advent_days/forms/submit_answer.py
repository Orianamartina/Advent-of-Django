...
class SubmissionForm(forms.Form):
    ...
    answer_part_one = forms.Textarea(widget=forms.Textarea(attrs={'class':'input-input'}))
    answer_part_two = forms.Textarea(widget=forms.Textarea(attrs={'class':'input-input'}))