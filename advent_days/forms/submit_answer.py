...
class SubmissionForm(forms.Form):
    ...
    answer_part_one = forms.CharField(widget=forms.Textarea(attrs={'class':'input-input'}))
    answer_part_two = forms.CharField(widget=forms.Textarea(attrs={'class':'input-input'}))