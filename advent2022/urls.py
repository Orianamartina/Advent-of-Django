...
from adventapi.views import solve_day, delete_day, create_days, get_user_days, home, submit_input, signup, user_profile, resolution_code, save_comment, my_profile, upload_image, update_image_template_view, like_post,unlike_post
